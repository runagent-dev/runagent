...
<CardGroup cols={3}>
  <Card title="Deploy your first agent (5 min)" href="./deploy-your-first-agent">
...
<CardGroup cols={3}>
  <Card title="Customer Support Agent" href="./customer-support-agent" />
  <Card title="Multi-Language Wrapper" href="./multi-language-wrapper" />
  <Card title="Internal Q&A Agent" href="./internal-qa-agent" />
