...
<CardGroup cols={2}>
  <Card title="🏗️ Core Concepts Deep Dive" icon="lightbulb" href="/explanation/core-concepts">
  ...
  <Card title="☁️ Production Deployment" icon="cloud" href="/how-to/deployment/cloud-deployment">
