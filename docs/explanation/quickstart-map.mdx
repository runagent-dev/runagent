...
<AccordionGroup>
  <Accordion title="👨‍💻 Developer / Engineer">
    ...
    **Then explore:**
    ...
    - [Production deployment](/deployment/cloud-deployment)
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="🔴 Advanced (Production experience)">
    **Recommended path:**
    ...
    4. [Cloud deployment](/deployment/cloud-deployment) (30 min)
...
<CardGroup cols={2}>
  ...
  <Card title="❓ How do I deploy to production?" icon="cloud">
    **Go to**: [Cloud deployment](/deployment/cloud-deployment)
