...
class RunAgentClient:
    ...
    def __init__(self, agent_id: str, entrypoint_tag: str, local: bool = True, host: str = None, port: int = None, user_id: str = None, persistent_memory: bool = False, api_key: str = None, base_url: str = None):
