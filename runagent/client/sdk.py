...
from .deployment import LocalDeployment, RemoteDeployment
...
class RunAgentSDK:
    ...
    def __init__(
        ...
        self.agents = AgentManager(self.config)
    ...
    # Template Methods
    def list_templates(self, framework: t.Optional[str] = None) -> t.Dict[str, t.List[str]]:
        """
    ...
    def get_template_info(self, framework: str, template: str) -> t.Optional[t.Dict[str, t.Any]]:
        """
    ...
    def deploy_local(
        ...
        """
        Deploy an agent locally for testing.
        ...
        """
        return self.local.deploy_agent(
            folder_path=folder,
            framework=framework,
    ...
    def run_local_agent(self, agent_id: str, input_data: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
        """
        Run a locally deployed agent via HTTP server.
        ...
        """
        return self.local.run_agent(agent_id, input_data)
    
    def run_local_agent_direct(self, agent_id: str, input_data: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
        """
        Run a locally deployed agent directly (bypass HTTP server).
        ...
        Returns:
            Agent execution result
        """
        return self.local.run_agent_direct(agent_id, input_data)
    ...
    def start_local_server(
        ...
        """
        Start the local FastAPI server for testing agents.
        ...
        """
        return self.local.start_server(port=port, host=host, debug=debug)
                ...
                if not error_msg or error_msg == 'None':
                    ...
                    if agent_info.get('success'):
                        ...
                        if not agent_data.get('deployment_exists'):
                            result['error'] = f"Agent {agent_id} deployment files not found"
                            ...
                            result['error'] = f"Agent {agent_id} execution failed with unknown error"
                    else:
    ...
    def validate_agent(self, folder: str) -> t.Tuple[bool, t.Dict[str, t.Any]]:
        ...
        """
        return self.agents.validate_agent(folder)
    ...
    def detect_framework(self, folder: str) -> str:
        ...
        """
        return self.agents.detect_framework(folder)
    ...
    def debug_agent(self, agent_id: str, local: bool = True) -> t.Dict[str, t.Any]:
        ...
        try:
            result = self.run_local_agent_direct(agent_id, {
