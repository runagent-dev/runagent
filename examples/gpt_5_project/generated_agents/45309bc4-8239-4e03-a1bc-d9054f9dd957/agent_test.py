...
def main():
    ...
    print(f"Framework: agno")
    print("=" * 60)
    
    # Prepare input data based on agent configuration
    input_data = {}
    input_data["title"] = test_message
    input_data["topic"] = "default"
    input_data["audience"] = "default"
    input_data["scope"] = "default"
    input_data["sources"] = "default"
    input_data["format_style"] = "default"
    input_data["length"] = "short"
    input_data["deadline"] = "default"
    input_data["include_summary"] = True
    input_data["include_recommendations"] = True
