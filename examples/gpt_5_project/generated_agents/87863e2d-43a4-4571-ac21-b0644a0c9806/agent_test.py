...
def main():
    ...
    input_data = {}
    input_data["user_query"] = test_message
    input_data["preferred_genres"] = []
    input_data["preferred_actors_directors"] = []
    input_data["release_year_range"] = "default"
    input_data["minimum_rating"] = 1
    input_data["language"] = "default"
    input_data["max_results"] = 1
    input_data["include_synopses"] = True
    input_data["explain_reasons"] = True
