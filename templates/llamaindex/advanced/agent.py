    ...
    def _create_default_documents(self) -> List[Document]:
        ...
        return [
            Document(
                ...
                metadata={"topic": "python", "category": "programming", "difficulty": "beginner"}
            ),
            Document(
                ...
                metadata={"topic": "ai", "category": "technology", "difficulty": "intermediate"}
            ),
            Document(
                ...
                metadata={"topic": "llamaindex", "category": "framework", "difficulty": "advanced"}
            ),
            Document(
                ...
                metadata={"topic": "machine-learning", "category": "technology", "difficulty": "intermediate"}
            ),
            Document(
                ...
                metadata={"topic": "data-science", "category": "methodology", "difficulty": "intermediate"}
            )
        ]
